...
Now the coefficient estimate on the initial income $Y_0$ is $\hat{\beta}_1=-0.5$ with heteroskedasticity-robust standard error 0.016. This result supports the neoclassical convergence argument. 
